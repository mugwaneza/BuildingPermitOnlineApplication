...
<div class="error-pagewrap">
    <div class="error-page-int">
        <div class="text-center m-b-md custom-login">
            <h3>PLEASE LOGIN TO Building Permit Online Application System</h3>
                ...
                <div class="panel-body">
                    <form action="/login" method="post" id="loginForm" autocomplete="off" >
                        ...
                        <div class="form-group {{ $errors->has('nid') ? ' has-error' : '' }}">
                            ...
                            <span class="help-block small">Type unique nid to BPOA</span><br>
                        ...
                        <div class="form-group {{ $errors->has('nid') ? ' has-error' : '' }}">
                            ...
                            <span class="help-block small">Type your password to BPOA</span><br>
